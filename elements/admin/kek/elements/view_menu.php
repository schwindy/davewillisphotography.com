<div class="menu_nav_container">
    <a
            ...
            href='/admin/kek/elements/edit?id=<?php echo $_REQUEST['id'] ?>'
    >
    ...
    <a
            id='menu_nav_2'
            class="menu_nav_element"
            href='/admin/kek/elements/copy?id=<?php echo $_REQUEST['id'] ?>'
    >
    ...
    <a
            ...
            href='/admin/kek/elements/delete?id=<?php echo $_REQUEST['id'] ?>'
    >
