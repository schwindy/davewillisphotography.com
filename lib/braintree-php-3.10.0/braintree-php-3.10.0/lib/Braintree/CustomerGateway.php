 ...
 *
 * For more detailed information on Customers, see
 * {@link http://www.braintreepayments.com/gateway/customer-api http://www.braintreepaymentsolutions.com/gateway/customer-api}
 *
 * @package    Braintree
 * @category   Resources
...
class CustomerGateway
{
    ...
    public function createFromTransparentRedirect($queryString)
    {
        ...
        return $this->_doCreate('/customers/all/confirm_transparent_redirect_request', ['id' => $params['id']]);
    }
     ...
     * {@link http://www.braintreepayments.com/gateway/customer-api#searching http://www.braintreepaymentsolutions.com/gateway/customer-api}
     *
    ...
    public function updateFromTransparentRedirect($queryString)
    {
        ...
        return $this->_doUpdate('post', '/customers/all/confirm_transparent_redirect_request', ['id' => $params['id']]);
    }
    ...
    protected function _initialize($customerAttribs)
    {
        ...
        $this->_set('paymentMethods',
            array_merge($this->creditCards, $this->paypalAccounts, $this->applePayCards, $this->coinbaseAccounts,
    ...
    public function defaultPaymentMethod()
    {
        $defaultPaymentMethods =
            array_filter($this->paymentMethods, 'Braintree\\Customer::_defaultPaymentMethodFilter');
