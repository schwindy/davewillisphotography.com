...
final class TransactionGateway
{
    ...
    public function createFromTransparentRedirect($queryString)
    {
        ...
        return $this->_doCreate('/transactions/all/confirm_transparent_redirect_request', ['id' => $params['id']]);
    }
     ...
     * {@link http://www.braintreepayments.com/gateway/transaction-api#searching http://www.braintreepaymentsolutions.com/gateway/transaction-api}
     *
