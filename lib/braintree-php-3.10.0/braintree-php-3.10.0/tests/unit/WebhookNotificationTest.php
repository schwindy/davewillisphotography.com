...
class WebhookNotificationTest extends Setup
{
     ...
     * @expectedExceptionMessage Braintree\Configuration::merchantId needs to be set (or accessToken needs to be passed
     *     to Braintree\Gateway)
     */
    ...
    {
        $sampleNotification =
            Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::SUBSCRIPTION_WENT_PAST_DUE,
                'my_id');

        $webhookNotification =
            Braintree\WebhookNotification::parse($sampleNotification['bt_signature'],
    ...
    public function testParsingModifiedSignatureRaisesError()
    {
        ...
        $webhookNotification =
            Braintree\WebhookNotification::parse($sampleNotification['bt_signature'] . "bad",
                $sampleNotification['bt_payload']);
    }
    ...
    public function testParsingUnknownPublicKeyRaisesError()
    {
        ...
        $webhookNotification =
            Braintree\WebhookNotification::parse("bad" . $sampleNotification['bt_signature'],
                $sampleNotification['bt_payload']);
    }
    ...
    public function testParsingInvalidCharactersRaisesError()
    {
        ...
        $webhookNotification =
            Braintree\WebhookNotification::parse($sampleNotification['bt_signature'], "~*~*invalid*~*~");
    }
    ...
    {
        $sampleNotification =
            Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::SUBSCRIPTION_CHARGED_SUCCESSFULLY,
                "my_id");
        ...
        $this->assertEquals(Braintree\WebhookNotification::SUBSCRIPTION_CHARGED_SUCCESSFULLY,
    ...
    {
        $sampleNotification =
            Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::SUB_MERCHANT_ACCOUNT_APPROVED,
                "my_id");
        ...
        $this->assertEquals(Braintree\MerchantAccount::STATUS_ACTIVE,
    ...
    {
        $sampleNotification =
            Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::SUB_MERCHANT_ACCOUNT_DECLINED,
                "my_id");
        ...
        $this->assertEquals("master_ma_for_my_id", $webhookNotification->merchantAccount->masterMerchantAccount->id);
        $this->assertEquals(Braintree\MerchantAccount::STATUS_SUSPENDED,
            $webhookNotification->merchantAccount->masterMerchantAccount->status);
    ...
    {
        $sampleNotification =
            Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::TRANSACTION_DISBURSED, "my_id");
    ...
    {
        $sampleNotification =
            Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::DISPUTE_OPENED, "my_id");
    ...
    {
        $sampleNotification =
            Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::DISPUTE_LOST, "my_id");
    ...
    {
        $sampleNotification =
            Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::DISPUTE_WON, "my_id");
    ...
    {
        $sampleNotification =
            Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::DISBURSEMENT_EXCEPTION,
                "my_id");
    ...
    {
        $sampleNotification =
            Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::DISBURSEMENT, "my_id");
    ...
    {
        $sampleNotification =
            Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::PARTNER_MERCHANT_CONNECTED,
                "my_id");
    ...
    {
        $sampleNotification =
            Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::PARTNER_MERCHANT_DISCONNECTED,
                "my_id");
    ...
    {
        $sampleNotification =
            Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::PARTNER_MERCHANT_DECLINED,
                "my_id");
    ...
    {
        $sampleNotification =
            Braintree\WebhookTesting::sampleNotification(Braintree\WebhookNotification::ACCOUNT_UPDATER_DAILY_REPORT,
                "my_id");
