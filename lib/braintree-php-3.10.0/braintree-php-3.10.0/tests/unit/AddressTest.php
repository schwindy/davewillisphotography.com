...
class AddressTest extends Setup
{
    ...
    {
        $first = Braintree\Address::factory(['customerId' => 'c1', 'id' => 'a1']);
        $second = Braintree\Address::factory(['customerId' => 'c1', 'id' => 'a1']);
    ...
    {
        $first = Braintree\Address::factory(['customerId' => 'c1', 'id' => 'a1']);
        $second = Braintree\Address::factory(['customerId' => 'c1', 'id' => 'not a1']);
    ...
    {
        $first = Braintree\Address::factory(['customerId' => 'c1', 'id' => 'a1']);
        $second = Braintree\Address::factory(['customerId' => 'not c1', 'id' => 'a1']);
