...
class TransactionTest extends Setup
{
    ...
    public function testCloneTransactionAndSubmitForSettlement()
    {
        ...
        $cloneResult =
            Braintree\Transaction::cloneTransaction($transaction->id,
                ['amount' => '123.45', 'options' => ['submitForSettlement' => true]]);
        $cloneTransaction = $cloneResult->transaction;
    ...
    public function testSale_isInvalidIfTransactionMerchantAccountIsNotSub()
    {
        ...
        $this->assertEquals(Braintree\Error\Codes::TRANSACTION_SERVICE_FEE_AMOUNT_NOT_ALLOWED_ON_MASTER_MERCHANT_ACCOUNT,
    ...
    public function testSale_isInvalidIfSubMerchantAccountHasNoServiceFee()
    {
        ...
        $this->assertEquals(Braintree\Error\Codes::TRANSACTION_SUB_MERCHANT_ACCOUNT_REQUIRES_SERVICE_FEE_AMOUNT,
            $serviceFeeErrors[0]->code);
    }
    ...
    public function testSale_withTooLongPurchaseOrderAttribute()
    {
        ...
        $this->assertEquals(Braintree\Error\Codes::TRANSACTION_PURCHASE_ORDER_NUMBER_IS_TOO_LONG,
    ...
    public function testSale_withInvalidPurchaseOrderNumber()
    {
        ...
        $purchaseOrderNumberErrors = $result->errors->forKey('transaction')->onAttribute('purchaseOrderNumber');
        $this->assertEquals(Braintree\Error\Codes::TRANSACTION_PURCHASE_ORDER_NUMBER_IS_INVALID,
            $purchaseOrderNumberErrors[0]->code);
    }
    ...
    public function testSubmitForSettlement_amountLessThanServiceFee()
    {
        ...
        $this->assertEquals(Braintree\Error\Codes::TRANSACTION_SETTLEMENT_AMOUNT_IS_LESS_THAN_SERVICE_FEE_AMOUNT,
            $errors[0]->code);
    }
    ...
    public function testSale_returnsErrorIf3dsLookupDataDoesNotMatchTransactionData()
    {
        ...
        $this->assertFalse($result->success);
        $errors = $result->errors->forKey('transaction')->onAttribute('threeDSecureToken');
        $this->assertEquals(Braintree\Error\Codes::TRANSACTION_THREE_D_SECURE_TRANSACTION_DATA_DOESNT_MATCH_VERIFY,
            $errors[0]->code);
    }
    ...
    public function createTransactionViaTr($regularParams, $trParams)
    {
        Test\Helper::suppressDeprecationWarnings();
        $trData =
            Braintree\TransparentRedirect::transactionData(array_merge($trParams,
    ...
    public function testCardTypeIndicators()
    {
        ...
        $this->assertEquals(Braintree\CreditCard::COMMERCIAL_YES,
            $prepaid_card_transaction->creditCardDetails->commercial);
        ...
        $this->assertEquals(Braintree\CreditCard::DURBIN_REGULATED_YES,
            $transaction->creditCardDetails->durbinRegulated);
    ...
    public function testCreate_withPayPalHandlesBadUnvalidatedNonces()
    {
        ...
        $this->assertEquals(Braintree\Error\Codes::PAYPAL_ACCOUNT_CANNOT_HAVE_BOTH_ACCESS_TOKEN_AND_CONSENT_CODE,
            $errors[0]->code);
    }
    ...
    public function testRefund_partialWithPayPal()
    {
        ...
        $result =
            Braintree\Transaction::refund($transactionResult->transaction->id,
    ...
    public function testSale_withLodgingIndustryDataValidation()
    {
        ...
        $this->assertEquals(Braintree\Error\Codes::INDUSTRY_DATA_LODGING_CHECK_OUT_DATE_MUST_FOLLOW_CHECK_IN_DATE,
            $errors[0]->code);
    }
    ...
    public function testSale_withTravelCruiseIndustryDataValidation()
    {
        ...
        $this->assertEquals(Braintree\Error\Codes::INDUSTRY_DATA_TRAVEL_CRUISE_TRAVEL_PACKAGE_IS_INVALID,
            $errors[0]->code);
    }
    ...
    public function testSubmitForPartialSettlement()
    {
        ...
        $partialSettlementResult1 =
            Braintree\Transaction::submitForPartialSettlement($authorizedTransaction->id, '60.00');
        $this->assertTrue($partialSettlementResult1->success);
        $this->assertEquals(Braintree\Transaction::SUBMITTED_FOR_SETTLEMENT,
            $partialSettlementResult1->transaction->status);
        $this->assertEquals('60.00', $partialSettlementResult1->transaction->amount);

        $partialSettlementResult2 =
            Braintree\Transaction::submitForPartialSettlement($authorizedTransaction->id, '40.00');
        $this->assertTrue($partialSettlementResult2->success);
        $this->assertEquals(Braintree\Transaction::SUBMITTED_FOR_SETTLEMENT,
            $partialSettlementResult2->transaction->status);
    ...
    public function testSubmitForPartialSettlementUnsuccesful()
    {
        ...
        $partialSettlementResult2 =
            Braintree\Transaction::submitForPartialSettlement($partialSettlementResult1->transaction->id, '10.00');
        ...
        $this->assertEquals(Braintree\Error\Codes::TRANSACTION_CANNOT_SUBMIT_FOR_PARTIAL_SETTLEMENT,
            $baseErrors[0]->code);
    }
    ...
    public function testSubmitForPartialSettlement_withOrderId()
    {
        ...
        $this->assertEquals(Braintree\Transaction::AUTHORIZED, $transaction->status);
        $submitResult =
            Braintree\Transaction::submitForPartialSettlement($transaction->id, '67.00', ['orderId' => 'ABC123']);
        $this->assertEquals(true, $submitResult->success);
        $this->assertEquals(Braintree\Transaction::SUBMITTED_FOR_SETTLEMENT, $submitResult->transaction->status);
        $this->assertEquals('ABC123', $submitResult->transaction->orderId);
        $this->assertEquals('67.00', $submitResult->transaction->amount);
    ...
    public function testFacilitatorDetailsAreReturnedOnTransactionsCreatedViaNonceGranting()
    {
        ...
        $this->assertEquals($result->transaction->facilitatorDetails->oauthApplicationClientId,
