...
class CustomerTest extends Setup
{
    ...
    public function testCreate_withValidationErrors()
    {
        ...
        $errors =
            $result->errors->forKey('customer')->forKey('creditCard')->forKey('billingAddress')->onAttribute('streetAddress');
    ...
    public function testCreate_countryValidations_inconsistency()
    {
        ...
        $this->assertEquals(false, $result->success);
        $errors =
            $result->errors->forKey('customer')->forKey('creditCard')->forKey('billingAddress')->onAttribute('base');
